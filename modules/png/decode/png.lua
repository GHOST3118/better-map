class = require 'map:png/decode/30log'
deflate = require 'map:png/decode/deflate'
require 'map:png/decode/stream'
...
function pngImage:__init(input, progCallback)
	local str = Stream({input = input})
	-- 89 50 4E 47 0D 0D 0A 1A
